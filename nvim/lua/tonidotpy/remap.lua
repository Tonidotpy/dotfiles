...
-- Open config files
map("n", "<leader>fc", ":e " .. os.getenv("XDG_CONFIG_HOME") .. "/nvim/lua/tonidotpy/set.lua<CR>", { desc = "open neovim configuration file" })
map("n", "<leader>fm", ":e " .. os.getenv("XDG_CONFIG_HOME") .. "/nvim/lua/tonidotpy/remap.lua<CR>", { desc = "open neovim remaps file" })
map("n", "<leader>fC", ":e " .. os.getenv('XDG_CONFIG_HOME') .. "<CR>", { desc = "open the XDG_CONFIG_HOME folder" })
map("n", "<leader>fd", ":e " .. os.getenv('HOME') .. "/Desktop<CR>", { desc = "open the desktop" })
map("n", "<leader>fw", ":e " .. os.getenv('HOME') .. "/Desktop/informatica/eagletrt<CR>", { desc = "open the work folder" })
